...
function historico(event) {
  ...
  if (cpfInput === "12345678900") {
    document.getElementById("name").innerHTML = '<p class="value">Alan Cristian</p>';
  ...
  } else if (cpfInput === "98765432100") {
    document.getElementById("name").innerHTML = '<p class="value">Maria Silva</p>';
    document.getElementById("cpf-result").textContent = '987.654.321-00';
    document.getElementById("pathology").innerHTML = '<p class="value">Hipertensão</p>';
    document.getElementById("injuries").innerHTML = 'Nenhuma';
    document.getElementById("surgeries").innerHTML = 'Nenhuma';
    document.getElementById("current-medications").innerHTML = 'Losartana 50mg';
    document.getElementById("family-history").innerHTML = '<p class="value">Diabetes</p><p class="value">Hipertensão</p><p class="value">Mal de Parkinson</p><p class="value">Alzheimer</p><p class="value">Ansiedade</p>';
    document.getElementById("allergies").innerHTML = 'Nenhuma';
  }
